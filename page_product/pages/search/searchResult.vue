	...
	<view class="search-result">
		<view class="top-fixd">
			...
			<view class="order-container">
				<view class="order-item" @click="changeType(item, index)" v-for="(item, index) in pxList" :key="index">
		...
		<view class="list-container" :style="'margin-top:' + contentHeight + 'px;'">
			<view @click="goDetail(item)" class="list-item" v-for="(item, index) in list" :key="index">
