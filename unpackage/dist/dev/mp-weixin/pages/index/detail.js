...
/* harmony import */ var _detail_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./detail.vue?vue&type=style&index=0&lang=css& */ 206);
    ...
    toComment: function toComment() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        if (![1, 2].includes(that.$store.state.theLogonUser.level)) {
          ...
          // });
          uni.navigateTo({
            url: "/pages/mine/register?level=" + that.$store.state.theLogonUser.level
          });
          return;
        }
