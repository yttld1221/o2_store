...
var _addMall = _interopRequireDefault(__webpack_require__(/*! ./page_product/pages/mall/addMall.vue */ 397));
// @ts-ignore
...
/* harmony import */ var _addMall_vue_vue_type_template_id_60437212_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./addMall.vue?vue&type=template&id=60437212&scoped=true& */ 398);
/* harmony import */ var _addMall_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./addMall.vue?vue&type=script&lang=js& */ 400);
...
/* harmony import */ var _addMall_vue_vue_type_style_index_0_id_60437212_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./addMall.vue?vue&type=style&index=0&id=60437212&lang=scss&scoped=true& */ 403);
...
try {
  components = {
    "u-Input": function () {
      return Promise.all(/*! import() | uni_modules/uview-ui/components/u--input/u--input */[__webpack_require__.e("common/vendor"), __webpack_require__.e("uni_modules/uview-ui/components/u--input/u--input")]).then(__webpack_require__.bind(null, /*! @/uni_modules/uview-ui/components/u--input/u--input.vue */ 854))
    },
    uIcon: function () {
...
var _cityData = __webpack_require__(/*! ../../components/piaoyi-cityPicker/cityData */ 402);
...
var _default = {
  ...
  onLoad: function onLoad(options) {
    ...
    uni.$on("changeArea", function (data) {
      ...
      _this.addressArr.forEach(function (el) {
        el.children.forEach(function (item) {
          if (item.value == data.code) {
            _this.ruleForm.area_text = el.label + item.label;
          }
        });
      });
    });
  ...
  methods: {
    ...
    addSubmit: function addSubmit() {
      ...
      if (tag) {
        this.API.order.applyShop(_objectSpread({}, this.ruleForm)).then(function (res) {
          uni.navigateBack({
            delta: 1,
      ...
      uni.chooseMedia({
        ...
        success: function success(res1) {
          ...
          tempFiles.forEach(function (file) {
            _this4.API.order.getOssUploadSign({
              type: "img"
            }).then(function (res) {
              console.log(res);
              var fileTypes = file.tempFilePath.substring(file.tempFilePath.lastIndexOf(".") + 1);
              var key = "".concat(res.data.dir).concat(_this4.$public.getNowDateTime(), "_mall_0_").concat(_this4.$store.state.theLogonUser.id, ".").concat(fileTypes);
              console.log(key, "key");
              uni.uploadFile({
                url: res.data.host,
                ...
                success: function success(uploadFileRes) {
                  ...
                  if (uploadFileRes.statusCode == 200) {
                    _this4.$set(_this4.ruleForm, types, "".concat(res.data.host, "/").concat(key));
                  }
                },
...
},[[396,"common/runtime","common/vendor","page_product/common/vendor"]]]);
