  ...
  methods: {
    ...
    inspect: function () {
      ...
      this.parameters.intro =
        theUser.intro == "" || theUser.intro == null ? "" : theUser.intro;
      this.parameters.nick_name =
        theUser.nick_name == "" || theUser.nick_name == null
          ? ""
          : theUser.nick_name;
      this.parameters.avatar_url =
        theUser.avatar_url == "" || theUser.avatar_url == null
          ? ""
          : theUser.avatar_url;
      this.parameters.birthday =
        theUser.birthday == "" || theUser.birthday == null
          ? ""
          : theUser.birthday;
      this.parameters.specialty =
        theUser.specialty == "" || theUser.specialty == null
          ? ""
          : theUser.specialty;
