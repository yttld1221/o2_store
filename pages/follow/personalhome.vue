<template>
	<view class="mall">
          ...
          userInfo.intro ? userInfo.intro : "这家伙很神秘，没有写个人简介。"
			...
			<view class="tab-container flex-algin">
				<view class="tab-box flex-algin">
					...
					<view class="tab-item" :class="{ choose: current == index }" v-for="(item, index) in list"
						:key="index">
		...
		<view :style="'margin-top:' + contentHeight + 'px;'" class="list-box">
			<view class="posts-data" :key="index" v-for="(item, index) in shopList">
